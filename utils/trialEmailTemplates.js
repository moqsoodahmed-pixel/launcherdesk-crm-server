...
const APP_URL = process.env.FRONTEND_URL || "https://app.launcherdesk.com";
const SUPPORT = process.env.SUPPORT_EMAIL || "support@launcherdesk.com";
const BRAND   = "Launcherdesk CRM";
