...
const sendViaMSG91 = async ({ mobile, name, templateId, senderId, authKey }) => {
  ...
  // MSG91 v5/flow payload for DLT template "Launcherdesk_greetings":
  //   "Hi ##alphanumeric##, thank you for contacting LAUNCHERDESK Digital Solutions LLP!..."
  //
  ...
  const payload = {
    ...
    sender:    senderId || "695382",  // DLT Sender ID for Launcherdesk_greetings
    short_url: "0",
...
const sendSingleSms = async (req, res) => {
  try {
    ...
    const logMessage = `Hi ${name || "there"}, thank you for contacting LAUNCHERDESK Digital Solutions LLP! Our Services:SEO Services, Social Media & GBP Management, Google & Meta Ads, Website Design & Development, AI Automation & Machine Learning, Chatbot & WhatsApp Automation. One of our team members will connect with you shortly. Phone: +91 88678 67775 Website: LAUNCHERDESK Digital Solutions LLP`;
