 ...
 *   the page — so e.g. "AI_cold" leads end up tagged as "launcherdesk_ads".
 ...
 *                                   by campaign name.
 *   --campaign="launcherdesk_ads"          Match legacy leads by campaign name
 ...
 *
 *   Dry-run: move every lead currently under the launcherdesk_ads config to AI_cold:
 *     node scripts/retagMetaLeads.js --fromConfig=<launcherdeskId> --toConfig=<aiColdId>
 *
 *   Apply it:
 *     node scripts/retagMetaLeads.js --fromConfig=<launcherdeskId> --toConfig=<aiColdId> --apply
 *
 *   Move specific leads:
