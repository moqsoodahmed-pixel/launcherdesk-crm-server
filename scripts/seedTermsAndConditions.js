...
// ─────────────────────────────────────────────────────────────────────────────
// Publishes version 1 of the Launcherdesk CRM Terms & Conditions.
//
...
const INTRO =
  "These Terms & Conditions ('Agreement') govern the use of Launcherdesk CRM provided by Launcherdesk. " +
  "By creating an account, subscribing to the Platform, or using any Launcherdesk CRM services, the Customer agrees to these Terms & Conditions.";

const SECTIONS = [
  { heading: "1. Acceptance of Terms", body: "By accessing or using Launcherdesk CRM, the Customer confirms that they have read, understood and agreed to these Terms. If using the Platform on behalf of an organization, the user represents that they have authority to bind that organization." },
  { heading: "2. Subscription and Billing", body: "Subscriptions are billed in advance. Fees are generally non-refundable unless required by law or agreed otherwise. Plans may renew automatically unless cancelled. Launcherdesk may revise pricing with prior notice. Failure to pay may result in suspension or termination." },
  { heading: "3. Customer Data Ownership", body: "All customer business data remains the property of the Customer. Launcherdesk does not claim ownership of Customer Data." },
  ...
  { heading: "10. Third-Party Integrations", body: "Integrations with Meta, Google, WhatsApp, MSG91, Brevo, Razorpay, Cloudinary, AI providers and others are governed by their own terms. Launcherdesk is not responsible for third-party outages or policy changes." },
  ...
  { heading: "18. Data Security", body: "Launcherdesk implements commercially reasonable safeguards but cannot guarantee absolute security." },
  ...
  { heading: "23. Intellectual Property", body: "All software, source code, branding and documentation remain the property of Launcherdesk." },
  ...
  { heading: "25. API Usage", body: "APIs, where available, must be used in accordance with Launcherdesk documentation and applicable rate limits." },
  ...
  { heading: "29. Security Incident Notification", body: "Launcherdesk will use commercially reasonable efforts to notify customers of confirmed security incidents affecting Customer Data." },
  { heading: "30. Force Majeure", body: "Launcherdesk is not liable for delays caused by events beyond reasonable control." },
  ...
  { heading: "32. Limitation of Liability", body: "Launcherdesk is not liable for indirect damages, unlawful recordings, consent failures, customer misuse, AI inaccuracies or third-party outages. Liability is limited to fees paid during the preceding 12 months, to the extent permitted by law." },
  { heading: "33. Indemnification", body: "Customers agree to indemnify Launcherdesk against claims arising from unlawful use, legal violations or misuse of the Platform." },
  { heading: "34. Privacy Policy", body: "Use of the Platform is also governed by the Launcherdesk CRM Privacy Policy." },
  ...
  { heading: "36. Amendments", body: "Launcherdesk may update these Terms. Continued use constitutes acceptance of revised Terms." },
...
async function seed() {
  ...
  await TermsAndConditions.create({
    version:       1,
    title:         "Launcherdesk CRM – Terms & Conditions",
