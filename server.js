...
// In .env:  ALLOWED_ORIGINS=http://localhost:5173,https://launcherdesk.com,...
...
app.get('/download', (req, res) => {
  const apkPath = path.join(__dirname, 'public', 'launcherdesk.apk');
  res.download(apkPath, 'LauncherdeskCRM.apk', (err) => {
  ...
  res.send(`
    ...
    <html>
      <head>
        ...
        <title>Install Launcherdesk CRM</title>
        <style>
